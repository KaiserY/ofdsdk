...
impl PublicRes {
  pub(crate) fn new_from_archive<R: std::io::Read + std::io::Seek>(
    ...
    let public_res_font_files = crate::common::load_zip_parts(
      &current_dir,
      public_res_font_files_paths,
      archive,
      |child_path, archive| {
        let resolved_path = {
    ...
    let public_res_media_files = crate::common::load_zip_parts(
      &current_dir,
      public_res_media_files_paths,
      archive,
      |child_path, archive| {
        let resolved_path = {
          let base_path = root_element.base_loc.clone();
